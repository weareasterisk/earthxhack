...
const data: Array<IFAQ> = [
  {
    ...
    answer: e(
      <p>Making a trip to Dallas? EarthxHack takes place from April 24-26 and is a 36-hour event. You can arrive Friday anytime after 12pm to attend Learn, Dream, or Build. Dream starts at 6pm Friday and goes until 10am Saturday, and Build starts at 9am Saturday. Stay tuned on our social media pages!</p>
    )
  },
  {
  ...
  },
  {
    ...
    answer: e(
      ...
      <p><i>If you’re under 18, you need a signed physical waiver from your parent or legal guardian to attend. We’ll send this to you before the event.</i></p>,
    )
  },
  {
  ...
  },
  {
    ...
    answer: e(
      <p>EarthxHack will be held at the Embarcadero Building in Fair Park in Dallas, TX from April 24-26, during Earthx2020.</p>
    )
  },
  {
